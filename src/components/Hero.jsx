    ...
    <section id="about" className="hero">
      <div className="hero-content">
        ...
        <div className="hero-links">
          ...
          <a href="https://github.com/mh0411" target="_blank" rel="noreferrer" className="btn-outline">
          ...
          <a href="https://linkedin.com/in/mh0411" target="_blank" rel="noreferrer" className="btn-outline">
            <svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18">
