...
const CONTACT = [
  {
    label: 'z.mike0411@gmail.com',
    href: 'mailto:z.mike0411@gmail.com',
    icon: (
  ...
  {
    label: 'github.com/mh0411',
    href: 'https://github.com/mh0411',
    icon: (
  ...
  {
    label: 'linkedin.com/in/mh0411',
    href: 'https://linkedin.com/in/mh0411',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor">
